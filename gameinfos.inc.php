...
$gameinfos = [
    ...
    'game_name' => "Gems of Iridescia",

    // Game publisher (use empty string if there is no publisher)
    'publisher' => 'Rock, Stone & Dice Games',

    // Url of game publisher website
    'publisher_website' => 'https://rockstoneanddice.com/',

    // Board Game Geek ID of the publisher
    'publisher_bgg_id' => 54555,
    ...
    'tie_breaker_description' => totranslate("Iridia Stone, then Throne, then Scepter, then Banner"),

    'tie_breaker_split' => [1000, 100, 10, 1],
    ...
    'player_colors' => ["ff0000", "0000ff", "008000", "ffa500"],
